...
import Application from './careerApplication.entity';
...
export class Career extends BaseEntity {
  ...
  @OneToOne(type => Application, (info) => info.position, {
    onDelete: 'SET NULL'
  })
  @JoinColumn()
  ...
  @ApiProperty({
    type: 'string',
    example: 'This is the meta:description value for the blog article',
  })
